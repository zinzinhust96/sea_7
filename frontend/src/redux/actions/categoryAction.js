...
import { GET_CATEGORIES_BY_ACCOUNT_URL } from '../../constants/endpoint';
...
export function getCategoriesByAccount(accountID) {
  ...
  return async (dispatch) => {
    ...
    try {
      const response = await fetchJSON(GET_CATEGORIES_BY_ACCOUNT_URL(accountID), {
        headers: {
